...
TOKEN = '7032036527:AAGrbfqoKaV4JokWxR_u4IfFYkHmFSoYwOw'
MONGO_URI = 'mongodb+srv://Magic:Spike@cluster0.fa68l.mongodb.net/TEST?retryWrites=true&w=majority&appName=Cluster0'
FORWARD_CHANNEL_ID = -1002222294117
CHANNEL_ID = -1002222294117
error_channel_id = -1002222294117
...
def create_inline_keyboard():
    ...
    button3 = types.InlineKeyboardButton(
        text="❤️‍🩹 𝗝𝗼𝗶𝗻 𝗚𝗼𝗗𝘅𝗟𝗲𝗴𝗲𝗻𝗱 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 ❤️‍🩹", url="https://t.me/+rzj8IlSLrB04YmI1")
    ...
    try:
        ...
        if not user_data:
            ...
            button = types.InlineKeyboardButton(
                text="❤️‍🩹 𝗝𝗼𝗶𝗻 𝗚𝗼𝗗𝘅𝗟𝗲𝗴𝗲𝗻𝗱 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 ❤️‍🩹", url="https://t.me/GoDxLegendOpB")
            markup.add(button)
